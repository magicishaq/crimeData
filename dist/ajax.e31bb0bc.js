...
function runScript() {
  var location = 'Birmingham'; //turn into function 

  var api = "1b4d147a771b3fdaab5cbdcb7fe437d4";

  function destinationResults(_x) {
    return _destinationResults.apply(this, arguments);
  }

  function _destinationResults() {
    _destinationResults = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
      var response;
  ...
  function runPromise(location) {
    ...
    var LOCATIONURL = "http://api.positionstack.com/v1/forward?access_key=".concat(api, "&query=").concat(location);
    return destinationResults(LOCATIONURL).then(function (_ref) {
      var data = _ref.data;
      ...
      var name = first.label;
      var POLICEURL = "https://data.police.uk/api/crimes-street/all-crime?lat=".concat(lat, "&lng=").concat(lng);
      return destinationResults(POLICEURL);
    }).then(function (data) {
      var num = 1;
      var numberOfCrimes = data.reduce(function (elm, acc) {
    ...
    }).then(function (numberOfCrimes) {
      var container = document.querySelector('.crime-container');
      var div = Object.keys(numberOfCrimes).map(function (elm) {
        var crimeDiv = document.createElement('div');
        crimeDiv.classList.add('crime');
        var textNode = document.createTextNode("".concat(elm, " ").concat(numberOfCrimes[elm], " "));
...
},{"babel-core/register":"node_modules/babel-core/register.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/ajax.e31bb0bc.js.map